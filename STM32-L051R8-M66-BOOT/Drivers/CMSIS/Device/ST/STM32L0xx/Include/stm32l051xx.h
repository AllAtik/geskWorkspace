...
#define I2C_ISR_f_timeoutMilisecondk          (0x1UL << I2C_ISR_TIMEOUT_Pos)             /*!< 0x00001000 */
#define I2C_ISR_TIMEOUT              I2C_ISR_f_timeoutMilisecondk                       /*!< Timeout or Tlow detection flag */
